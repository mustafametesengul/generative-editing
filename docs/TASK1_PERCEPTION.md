...
- `structure_guard`: Canny/learned boundaries plus person, vehicle, text, sign, and logo instances. OCR polygons and face/plate detections are hard guards in production.
